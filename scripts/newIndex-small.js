...
function init() {
  ...
  ee = document.getElementById('back-brand').appendChild( renderer.domElement );
...
function loadRing() {
  ...
  var pointLight = new THREE.PointLight( 0x3caea3, 0.5);
  ring.add( pointLight );
  scene.add( ring );

export default {
  ...
  data: [
    ...
    {
      active: true,
      displaysrc : "./media/CPR.png",
      mainsrc : "./media/project-media/CPR-team.jpg",
    ...
    {
      active: true,
      displaysrc : "./media/hrm.png",
      mainsrc : "./media/project-media/hrm-circuit.jpg",
